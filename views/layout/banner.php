...
<div id="carousel-home" class="add_top_5">
			<div class="owl-carousel owl-theme">
				<div class="owl-slide cover" style="background-image: url(assets/img/slides/slide_home_2.jpg);">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(assets/img/slides/slide_home_1.jpg);">
					<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
						<div class="container">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(assets/img/slides/slide_home_3.jpg);">
