			...
			<div class="container">
				<div class="row small-gutters">
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
						<div id="logo">
							<a href="index.php?act=/"><img src="assets/img/logodass.png" alt="" width="100" height="35"></a>
						</div>
					</div>
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu">
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="show-submenu">Giới Thiệu</a>
									<!-- <ul>
								...
								<li>
									<a href="https://1.envato.market/3KVvr" target="_parent">Liên Hệ</a>
								</li>
							</ul>
						</div>
						<!--/main-menu -->
							...
							<li>
								<div class="dropdown dropdown-access">
									...
									<div class="dropdown-menu">
										...
										<ul>
											<li>
												<a href="track-order.html"><i class="ti-truck"></i>Giao hàng</a>
											</li>
											<li>
												<a href="my-orders.html"><i class="ti-package"></i>Đơn hàng</a>
											</li>
											<li>
												<a href="profile-page.html"><i class="ti-user"></i>Thông tin cá nhân</a>
											</li>
											<li>
